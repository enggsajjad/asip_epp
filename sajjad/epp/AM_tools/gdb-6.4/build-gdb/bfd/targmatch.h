...
#if !defined (SELECT_VECS) || defined (HAVE_bfd_elf32_littlebrownie32_vec)

{ "brownie32*el-*-netbsd*",
&bfd_elf32_littlebrownie32_vec },
#endif


    
#if !defined (SELECT_VECS) || defined (HAVE_bfd_elf32_bigbrownie32_vec)

{ "brownie32*-*-netbsd*",
&bfd_elf32_bigbrownie32_vec },
#endif
...
{ "brownie32*-dec-*", NULL },{ "brownie32*el-*-ecoff*",
&ecoff_little_vec },
#endif
...
#ifdef BFD64
#if !defined (SELECT_VECS) || defined (HAVE_bfd_elf32_nbigbrownie32_vec)

{ "brownie32*-*-irix6*",
&bfd_elf32_nbigbrownie32_vec },
#endif
...
{ "brownie32*-sgi-*", NULL },{ "brownie32*-*-bsd*",
&ecoff_big_vec },
#endif
...
#if !defined (SELECT_VECS) || defined (HAVE_bfd_elf32_tradbigbrownie32_vec)

{ "brownie32*-*-sysv4*",
&bfd_elf32_tradbigbrownie32_vec },
#endif
...
{ "brownie32*-*-sysv*", NULL },{ "brownie32*-*-riscos*",
&ecoff_big_vec },
#endif
...
{ "brownie32*el-*-elf*", NULL },{ "brownie32*el-*-vxworks*", NULL },{ "brownie32*-*-chorus*",
&bfd_elf32_littlebrownie32_vec },
#endif
...
{ "brownie32*-*-elf*", NULL },{ "brownie32*-*-rtems*", NULL },{ "brownie32*-*-vxworks", NULL },{ "brownie32*-*-windiss",
&bfd_elf32_bigbrownie32_vec },
#endif
...
#ifdef BFD64
#if !defined (SELECT_VECS) || defined (HAVE_bfd_elf64_tradbigbrownie32_vec)

{ "brownie3264*-*-openbsd*",
&bfd_elf64_tradbigbrownie32_vec },
#endif
...
#ifdef BFD64
#if !defined (SELECT_VECS) || defined (HAVE_bfd_elf32_ntradlittlebrownie32_vec)

{ "brownie3264*el-*-linux*",
&bfd_elf32_ntradlittlebrownie32_vec },
#endif


    
#if !defined (SELECT_VECS) || defined (HAVE_bfd_elf32_ntradbigbrownie32_vec)

{ "brownie3264*-*-linux*",
&bfd_elf32_ntradbigbrownie32_vec },
#endif


    
#endif
#if !defined (SELECT_VECS) || defined (HAVE_bfd_elf32_tradlittlebrownie32_vec)

{ "brownie32*el-*-linux*",
&bfd_elf32_tradlittlebrownie32_vec },
#endif

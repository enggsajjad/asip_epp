struct fn_decl std_protos[] = {
  ...
  {"__major", "major_t", "int, short", 0},
  {"__makedev", "short", "int, major_t, minor_t", 0},
  {"__minor", "minor_t", "int, short", 0},
  ...
  {"_xmknod", "int", "int, const char *, int, short", 0},
  ...
  {"baudrate", "int", "void", 0},
  {"bcmp", "int", "const void *, const void *, __SIZE_TYPE__", 0},
  {"bcopy", "void", "const void *, void *, __SIZE_TYPE__", 0},
  {"beep", "int", "void", 0},
  {"bgets", "char *", "char *, __SIZE_TYPE__, FILE *, char *", 0},
  {"bottom_panel", "int", "PANEL *", 0},
  {"box", "int", "WINDOW *, int, int", 0},
  {"brk", "int", "void *", 0},
  {"bsearch", "void *", "const void *, const void *, __SIZE_TYPE__, __SIZE_TYPE__, int (*) (const void *, const void *)", 0},
  {"bufsplit", "__SIZE_TYPE__", "char *, __SIZE_TYPE__, char *", 0},
  {"bzero", "void", "void *, __SIZE_TYPE__", 0},
  {"calchash", "long int", "", 0},
  {"calloc", "void *", "__SIZE_TYPE__, __SIZE_TYPE__", 0},
  ...
  {"cftime", "int", "char *, char *, const long *", 0},
  {"chdir", "int", "const char *", 0},
  {"chmod", "int", "const char *, int", 0},
  {"chown", "int", "const char *, unsigned short, unsigned short", 0},
  ...
  {"elf32_fsize", "__SIZE_TYPE__", "Elf_Type, __SIZE_TYPE__, unsigned int", 0},
  ...
  {"elf32_newphdr", "Elf32_Phdr *", "Elf *, __SIZE_TYPE__", 0},
  ...
  {"elf_getarsym", "Elf_Arsym *", "Elf *, __SIZE_TYPE__ *", 0},
  {"elf_getbase", "long", "Elf *", 0},
  {"elf_getdata", "Elf_Data *", "Elf_Scn *, Elf_Data *", 0},
  {"elf_getident", "char *", "Elf *, __SIZE_TYPE__ *", 0},
  {"elf_getscn", "Elf_Scn *", "Elf *, __SIZE_TYPE__", 0},
  {"elf_hash", "long unsigned int", "const char *", 0},
  {"elf_kind", "Elf_Kind", "Elf *", 0},
  {"elf_ndxscn", "__SIZE_TYPE__", "Elf_Scn *", 0},
  {"elf_newdata", "Elf_Data *", "Elf_Scn *", 0},
  {"elf_newscn", "Elf_Scn *", "Elf *", 0},
  {"elf_next", "Elf_Cmd", "Elf *", 0},
  {"elf_nextscn", "Elf_Scn *", "Elf *, Elf_Scn *", 0},
  {"elf_rand", "__SIZE_TYPE__", "Elf *, __SIZE_TYPE__", 0},
  {"elf_rawdata", "Elf_Data *", "Elf_Scn *, Elf_Data *", 0},
  {"elf_rawfile", "char *", "Elf *, __SIZE_TYPE__ *", 0},
  {"elf_strptr", "char *", "Elf *, __SIZE_TYPE__, __SIZE_TYPE__", 0},
  {"elf_update", "long", "Elf *, Elf_Cmd", 0},
  ...
  {"fchdir", "int", "int", 0},
  {"fchmod", "int", "int, int", 0},
  {"fchown", "int", "int, unsigned short, unsigned short", 0},
  {"fclose", "int", "FILE *", 0},
  {"fcntl", "int", "int, int, ...", 0},
  ...
  {"fread", "__SIZE_TYPE__", "void *, __SIZE_TYPE__, __SIZE_TYPE__, FILE *", 0},
  {"free", "void", "void *", 0},
  ...
  {"getcwd", "char *", "char *, __SIZE_TYPE__", 0},
  ...
  {"getpwuid", "struct passwd *", "unsigned short", 0},
  ...
  {"initgroups", "int", "const char *, unsigned short", 0},
  {"initscr", "WINDOW *", "", 0},
  {"initscr", "WINDOW *", "void", 0},
  ...
  {"iscntrl", "int", "int", 0},
  {"isdigit", "int", "int", 0},
  {"isencrypt", "int", "const char *, __SIZE_TYPE__", 0},
  {"isendwin", "int", "void", 0},
  {"isgraph", "int", "int", 0},
  {"isinf", "int", "double", 0},
  {"islower", "int", "int", 0},
  ...
  {"ladd", "dl_t", "", 0},
  {"lchown", "int", "const char *, unsigned short, unsigned short", 0},
  {"lckpwdf", "int", "void", 0},
  ...
  {"lexp10", "dl_t", "", 0},
  {"lfind", "void *", "const void *, const void *, __SIZE_TYPE__ *, __SIZE_TYPE__, int (*) (const void *, const void *)", 0},
  ...
  {"localtime", "struct tm *", "const long *", 0},
  {"lock", "int", "int, int, long", 0},
  {"lockf", "int", "int, int, long", 0},
  {"log", "double", "double", 0},
  ...
  {"lsearch", "void *", "const void *, void *, __SIZE_TYPE__ *, __SIZE_TYPE__, int (*) (const void *, const void *)", 0},
  {"lseek", "long", "int, long, int", 0},
  {"lshiftl", "dl_t", "", 0},
  ...
  {"major", "major_t", "short", 0},
  {"makdatum", "datum", "", 0},
  {"makecontext", "void", "ucontext_t *, void (*) (), int, ...", 0},
  {"makedev", "short", "major_t, minor_t", 0},
  {"makeutx", "struct utmpx *", "const struct utmpx *", 0},
  {"mallinfo", "struct mallinfo", "void", 0},
  {"malloc", "void *", "__SIZE_TYPE__", 0},
  {"mallopt", "int", "int, int", 0},
  {"map_button", "int", "long unsigned int", 0},
  {"matherr", "int", "struct exception *", 0},
  {"mbftowc", "int", "char *, __WCHAR_TYPE__ *, int (*) (), int *", 0},
  {"mblen", "int", "const char *, __SIZE_TYPE__", 0},
  {"mbstowcs", "__SIZE_TYPE__", "__WCHAR_TYPE__ *, const char *, __SIZE_TYPE__", 0},
  {"mbtowc", "int", "__WCHAR_TYPE__ *, const char *, __SIZE_TYPE__", 0},
  {"memalign", "void *", "__SIZE_TYPE__, __SIZE_TYPE__", 0},
  {"memccpy", "void *", "void *, const void *, int, __SIZE_TYPE__", 0},
  {"memchr", "void *", "const void *, int, __SIZE_TYPE__", 0},
  {"memcmp", "int", "const void *, const void *, __SIZE_TYPE__", 0},
  {"memcpy", "void *", "void *, const void *, __SIZE_TYPE__", 0},
  {"memlock", "int", "", 0},
  {"memlocked", "int", "", 0},
  {"memmove", "void *", "void *, const void *, __SIZE_TYPE__", 0},
  {"memset", "void *", "void *, int, __SIZE_TYPE__", 0},
  {"memunlock", "int", "", 0},
  {"menu_back", "int", "MENU *", 0},
  {"menu_driver", "int", "MENU *, int", 0},
  {"menu_fore", "int", "MENU *", 0},
  {"menu_format", "void", "MENU *, int *, int *", 0},
  {"menu_grey", "int", "MENU *", 0},
  ...
  {"mfree", "void", "struct map *, __SIZE_TYPE__, u_long", 0},
  {"mincore", "int", "caddr_t, __SIZE_TYPE__, char *", 0},
  {"minor", "minor_t", "short", 0},
  {"mkdir", "int", "const char *, int", 0},
  {"mkdirp", "int", "const char *, int", 0},
  {"mkfifo", "int", "const char *, int", 0},
  {"mknod", "int", "const char *, int, short", 0},
  {"mkstemp", "int", "char *", 0},
  {"mktemp", "char *", "char *", 0},
  {"mktime", "long", "struct tm *", 0},
  {"mmap", "caddr_t", "", 0},
  ...
  {"msgrcv", "int", "int, void *, __SIZE_TYPE__, long int, int", 0},
  {"msgsnd", "int", "int, const void *, __SIZE_TYPE__, int", 0},
  {"munmap", "int", "", 0},
  ...
  {"printw", "int", "char *, ...", 0},
  {"privsig", "void", "", 0},
  {"profil", "void", "short unsigned int *, __SIZE_TYPE__, int, unsigned int", 0},
  {"psiginfo", "void", "siginfo_t *, char *", 0},
  {"psignal", "void", "int, const char *", 0},
  {"ptrace", "int", "int, int, int, int", 0},
  {"putc", "int", "int, FILE *", 0},
  {"putchar", "int", "int", 0},
  {"putenv", "int", "char *", 0},
  ...
  {"qsort", "void", "void *, __SIZE_TYPE__, __SIZE_TYPE__, int (*) (const void *, const void *)", 0},
  {"raise", "int", "int", 0},
  {"rand", "int", "void", 0},
  {"random", "long", "void", 0},
  {"raw", "int", "void", 0},
  {"read", "int", "int, void *, __SIZE_TYPE__", 0},
  {"readdir", "struct dirent *", "DIR *", 0},
  {"readlink", "int", "const char *, char *, __SIZE_TYPE__", 0},
  {"realloc", "void *", "void *, __SIZE_TYPE__", 0},
  ...
  {"set_field_back", "int", "FIELD *, int", 0},
  {"set_field_buffer", "int", "FIELD *, int, char *", 0},
  {"set_field_fore", "int", "FIELD *, int", 0},
  ...
  {"set_menu_back", "int", "MENU *, int", 0},
  {"set_menu_fore", "int", "MENU *, int", 0},
  {"set_menu_format", "int", "MENU *, int, int", 0},
  {"set_menu_grey", "int", "MENU *, int", 0},
  ...
  {"setgid", "int", "unsigned short", 0},
  {"setgrent", "void", "void", 0},
  {"setgroups", "int", "int, const unsigned short *", 0},
  ...
  {"setpgid", "int", "int, int", 0},
  {"setpgrp", "int", "void", 0},
  {"setpgrp2", "int", "int, int", 0},
  {"setpriority", "int", "int, int, int", 0},
  {"setprivwait", "int", "", 0},
  {"setpwent", "void", "void", 0},
  {"setregid", "int", "unsigned short, unsigned short", 0},
  {"setreuid", "int", "unsigned short, unsigned short", 0},
  ...
  {"slk_attroff", "int", "int", 0},
  {"slk_attron", "int", "int", 0},
  {"slk_attrset", "int", "int", 0},
  ...
  {"strcspn", "__SIZE_TYPE__", "const char *, const char *", 0},
  ...
  {"strftime", "__SIZE_TYPE__", "char *, __SIZE_TYPE__, const char *, const struct tm *", 0},
  {"strlen", "__SIZE_TYPE__", "const char *", 0},
  {"strncasecmp", "int", "const char *, const char *, __SIZE_TYPE__", 0},
  {"strncat", "char *", "char *, const char *, __SIZE_TYPE__", 0},
  {"strncmp", "int", "const char *, const char *, __SIZE_TYPE__", 0},
  {"strncpy", "char *", "char *, const char *, __SIZE_TYPE__", 0},
  {"strpbrk", "char *", "const char *, const char *", 0},
  {"strrchr", "char *", "const char *, int", 0},
  {"strrspn", "char *", "const char *, const char *", 0},
  {"strspn", "__SIZE_TYPE__", "const char *, const char *", 0},
  ...
  {"strxfrm", "__SIZE_TYPE__", "char *, const char *, __SIZE_TYPE__", 0},
  ...
  {"time", "long", "long *", 0},
  {"times", "unsigned long", "struct tms *", 0},
  ...
  {"traceoff", "int", "void", 0},
  {"traceon", "int", "void", 0},
  {"truncate", "int", "const char *, long", 0},
  ...
  {"ustat", "int", "short, struct ustat *", 0},
  ...
  {"vadvise", "int", "int", 0},
  {"valloc", "void *", "__SIZE_TYPE__", 0},
  {"vfork", "int", "void", 0},
  {"vfprintf", "int", "FILE *, const char *, __gnuc_va_list", 0},
  {"vhangup", "int", "void", 0},
  {"vid32attr", "int", "int", 0},
  {"vid32puts", "int", "int, int (*) (char)", 0},
  {"vidupdate", "void", "int, int, int (*) (char)", 0},
  {"vn_close", "int", "", 0},
  ...
  {"waddch", "int", "WINDOW *, int", 0},
  {"w32attroff", "int", "WINDOW *, int", 0},
  {"w32attron", "int", "WINDOW *, int", 0},
  {"w32attrset", "int", "WINDOW *, int", 0},
  {"w32echochar", "int", "WINDOW *, int", 0},
  {"winsch", "int", "WINDOW *, int", 0},
  {"waddchnstr", "int", "WINDOW *, int *, int", 0},
  {"waddnstr", "int", "WINDOW *, char *, int", 0},
  {"waddstr", "int", "WINDOW *, char *", 0},
  {"wait", "int", "void *", 0},
  {"wait3", "int", "union wait *, int, struct rusage *", 0},
  {"waitid", "int", "idtype_t, id_t, siginfo_t *, int", 0},
  {"waitpid", "int", "int, int *, int", 0},
  {"wallproc_wall_1", "void *", "", 0},
  {"wbkgd", "int", "WINDOW *, int", 0},
  {"wbkgdset", "void", "WINDOW *, int", 0},
  {"wborder", "int", "WINDOW *, int, int, int, int, int, int, int, int", 0},
  {"wclear", "int", "WINDOW *", 0},
  {"wclrtobot", "int", "WINDOW *", 0},
  {"wclrtoeol", "int", "WINDOW *", 0},
  {"wcstombs", "__SIZE_TYPE__", "char *, const __WCHAR_TYPE__ *, __SIZE_TYPE__", 0},
  {"wctomb", "int", "char *, __WCHAR_TYPE__", 0},
  ...
  {"whline", "int", "WINDOW *, int, int", 0},
  {"winch", "int", "WINDOW *", 0},
  {"winchnstr", "int", "WINDOW *, int *, int", 0},
  {"winchstr", "int", "WINDOW *, int *", 0},
  ...
  {"write", "int", "int, const void *, __SIZE_TYPE__", 0},
  {"wscanw", "int", "WINDOW *, ...", 0},

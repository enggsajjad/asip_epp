...
_inner: 
	...
	add %r1, %r8, %r0	;       tmp = value_j;
	add %r8, %r9, %r0	;       value_j = value_next_j;
	nop
	nop
	add %r9, %r1, %r0	;       value_next_j = tmp;

_ifende: ;     }
	add %r5, %r7, %r0	;     j = next_j;
	nop
	nop
	add %r8, %r9, %r0	;     value_j = value_next_j;
	j _inner

...
_bubbleSort:
	...
	sw	-48(%r29), %r30		; Save the frame pointer 
	sw	-44(%r29), %r31		; Save the return address 

	; Save Registers 
	sw	 -40(%r29), %r1		; r1 is used for comparing-results and for temporary stuff.
...
_innerLoop:	
	...
	lw	%r9, 4(%r7)		
	bgeu	%r5, %r6, _noInnerLoop
	add	%r1, %r0, %r8		
	addi	%r7, %r7, $4		
	
	bgeu	%r9, %r8, _innernoif				
	add	%r8, %r0, %r9		
	add	%r9, %r0, %r1		
	sw	0(%r7), %r8		
	sw	0(%r5), %r9		

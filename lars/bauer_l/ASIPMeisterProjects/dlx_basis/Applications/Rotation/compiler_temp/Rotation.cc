...
struct point* rotate(struct point* center, struct point* p, int alpha) {
  ...
  t_print("sinAlpha=");
  intToStr(sinAlpha, tempString);
  t_print(tempString);  
  t_print(" deltaX=");
  intToStr(deltaX, tempString);
  t_print(tempString);
  t_print("\r\ncosAlpha=");
  intToStr(cosAlpha, tempString);
  t_print(tempString);
  t_print(" deltaY=");
  intToStr(deltaY, tempString);
  t_print(tempString);

  temp1 = sinAlpha*deltaX;
  t_print("\r\ntemp1=");
  intToStr(temp1, tempString);
  t_print(tempString);

  temp2 = cosAlpha*deltaY;
  t_print(" temp2=");
  intToStr(temp2, tempString);
  t_print(tempString);

  resultPoint.y = temp1+temp2;//sinAlpha*deltaX + cosAlpha*deltaY;
  t_print(" resultPoint.y=");
  intToStr(resultPoint.y, tempString);
  t_print(tempString);

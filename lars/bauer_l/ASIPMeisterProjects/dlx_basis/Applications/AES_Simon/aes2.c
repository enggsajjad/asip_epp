...
#define MAXBC				4 //(256/32)
#define MAXKC				4 //(256/32)
#define MAXROUNDS			14
...
//State and RoundKey
word8 state[4][MAXBC];
word8 roundKey[MAXROUNDS+1][4][MAXBC];
...
int AddRoundKey(word8 a[4][MAXBC], word8 rk[4][MAXBC], word8 BC) {
...
int ShiftRows(word8 a[4][MAXBC], word8 d, word8 BC) {
...
int Substitution(word8 a[4][MAXBC], word8 box[256], word8 BC) {
...
int MixColumns(word8 a[4][MAXBC], word8 BC) {
...
int InvMixColumns(word8 a[4][MAXBC], word8 BC) {
        /* Mix the four bytes of every column in a linear way
...
int rijndaelEncrypt (word8 a[4][MAXBC], word8 rk[MAXROUNDS+1][4][MAXBC])
{
...
int rijndaelDecrypt (word8 a[4][MAXBC], word8 rk[MAXROUNDS+1][4][MAXBC])
{
	int r, ROUNDS;
	word8 BC;
...
int main() {
	...
	//Input = 3243f6a8885a308d313198a2e0370734 (pi * 2^124)
	...
	rijndaelKeySched(state, roundKey);

	rijndaelEncrypt(state, roundKey);
	rijndaelDecrypt(state, roundKey);

...
struct doubleInt Hadamard_2x2_Chroma(int in1, int in2)
{
	...
	/*  DATA PACKING			  */
	dest.a  =   (((t0&0x0000FFFF)<<16) | (t2&0x0000FFFF));
	dest.b  =   (((t1&0x0000FFFF)<<16) | (t3&0x0000FFFF));
...
int SATD_4x4(int* SB_start, int Stride, int* Cand_start)
{
	...
	diff0		=	(((((SB_start[0]&0xFF000000)>>24) - ((Cand_start[0]&0xFF000000)>>24))<<16) | ((((SB_start[0]&0x00FF0000)>>16) - ((Cand_start[0]&0x00FF0000)>>16))&0x0000FFFF));
	diff1		=	(((((SB_start[0]&0x0000FF00)>>8) - ((Cand_start[0]&0x0000FF00)>>8))<<16) | (((SB_start[0]&0x000000FF) - (Cand_start[0]&0x000000FF))&0x0000FFFF));
	SB_start	+=	Stride; 	Cand_start	+=	4;

	diff2		=	(((((SB_start[0]&0xFF000000)>>24) - ((Cand_start[0]&0xFF000000)>>24))<<16) | ((((SB_start[0]&0x00FF0000)>>16) - ((Cand_start[0]&0x00FF0000)>>16))&0x0000FFFF));
	diff3		=	(((((SB_start[0]&0x0000FF00)>>8) - ((Cand_start[0]&0x0000FF00)>>8))<<16) | (((SB_start[0]&0x000000FF) - (Cand_start[0]&0x000000FF))&0x0000FFFF));
	SB_start	+=	Stride; 	Cand_start	+=	4;

	diff4		=	(((((SB_start[0]&0xFF000000)>>24) - ((Cand_start[0]&0xFF000000)>>24))<<16) | ((((SB_start[0]&0x00FF0000)>>16) - ((Cand_start[0]&0x00FF0000)>>16))&0x0000FFFF));
	diff5		=	(((((SB_start[0]&0x0000FF00)>>8) - ((Cand_start[0]&0x0000FF00)>>8))<<16) | (((SB_start[0]&0x000000FF) - (Cand_start[0]&0x000000FF))&0x0000FFFF));
	SB_start	+=	Stride; 	Cand_start	+=	4;

	diff6		=	(((((SB_start[0]&0xFF000000)>>24) - ((Cand_start[0]&0xFF000000)>>24))<<16) | ((((SB_start[0]&0x00FF0000)>>16) - ((Cand_start[0]&0x00FF0000)>>16))&0x0000FFFF));
	diff7		=	(((((SB_start[0]&0x0000FF00)>>8) - ((Cand_start[0]&0x0000FF00)>>8))<<16) | (((SB_start[0]&0x000000FF) - (Cand_start[0]&0x000000FF))&0x0000FFFF));
...
int DCT_4x4(int* SB_start, int Stride, int* SubPred_start, int* DCT_start)
{
	...
	/* DATA INITIALIZATION */
	/*	DIFFERENCE CALCULATION		*/
	diff0		=	(((((SB_start[0]&0xFF000000)>>24) - ((SubPred_start[0]&0xFF000000)>>24))<<16) | ((((SB_start[0]&0x00FF0000)>>16) - ((SubPred_start[0]&0x00FF0000)>>16))&0x0000FFFF));
	diff1		=	(((((SB_start[0]&0x0000FF00)>>8) - ((SubPred_start[0]&0x0000FF00)>>8))<<16) | (((SB_start[0]&0x000000FF) - (SubPred_start[0]&0x000000FF))&0x0000FFFF));
	SB_start	+=	Stride; 	SubPred_start	+=	1;

	diff2		=	(((((SB_start[0]&0xFF000000)>>24) - ((SubPred_start[0]&0xFF000000)>>24))<<16) | ((((SB_start[0]&0x00FF0000)>>16) - ((SubPred_start[0]&0x00FF0000)>>16))&0x0000FFFF));
	diff3		=	(((((SB_start[0]&0x0000FF00)>>8) - ((SubPred_start[0]&0x0000FF00)>>8))<<16) | (((SB_start[0]&0x000000FF) - (SubPred_start[0]&0x000000FF))&0x0000FFFF));
	SB_start	+=	Stride; 	SubPred_start	+=	1;

	diff4		=	(((((SB_start[0]&0xFF000000)>>24) - ((SubPred_start[0]&0xFF000000)>>24))<<16) | ((((SB_start[0]&0x00FF0000)>>16) - ((SubPred_start[0]&0x00FF0000)>>16))&0x0000FFFF));
	diff5		=	(((((SB_start[0]&0x0000FF00)>>8) - ((SubPred_start[0]&0x0000FF00)>>8))<<16) | (((SB_start[0]&0x000000FF) - (SubPred_start[0]&0x000000FF))&0x0000FFFF));
	SB_start	+=	Stride; 	SubPred_start	+=	1;

	diff6		=	(((((SB_start[0]&0xFF000000)>>24) - ((SubPred_start[0]&0xFF000000)>>24))<<16) | ((((SB_start[0]&0x00FF0000)>>16) - ((SubPred_start[0]&0x00FF0000)>>16))&0x0000FFFF));
	diff7		=	(((((SB_start[0]&0x0000FF00)>>8) - ((SubPred_start[0]&0x0000FF00)>>8))<<16) | (((SB_start[0]&0x000000FF) - (SubPred_start[0]&0x000000FF))&0x0000FFFF));

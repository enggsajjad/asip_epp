...
"OP-code"{"binary"{"00000000000000000000000000"},width{"25","0"}}
}
,"RR_B"{
"OP-code"{"name"{"opecode"},width{"31","26"}},
"Operand"{"name"{"rs0"},width{"25","21"}},
...
"Operand"{"name"{"mask"},width{"20","16"}},
"Operand"{"name"{"rd"},width{"15","11"}},
"Operand"{"name"{"shift"},width{"10","6"}},
"OP-code"{"name"{"func"},width{"5","0"}}
}
,"R_R_Rb"{
"OP-code"{"name"{"opcode"},width{"31","26"}},
...
},"bgeu"{type{"RR_B"},"OP-code"{"binary"{"111110"},width{"31","26"}},
"Operand"{"name"{"rs0"},width{"25","21"}},
"Operand"{"name"{"rs1"},width{"20","16"}},
"Operand"{"name"{"const"},width{"15","0"}}
},"xchg"{type{"R_R_s"},"OP-code"{"binary"{"000001"},width{"31","26"}},
"Operand"{"name"{"rs0"},width{"25","21"}},
"Operand"{"name"{"rs1"},width{"20","16"}},
"OP-code"{"binary"{"1000000000000000"},width{"15","0"}}
},"mac"{type{"R_R"},"OP-code"{"binary"{"000001"},width{"31","26"}},
"Operand"{"name"{"rs0"},width{"25","21"}},
"Operand"{"name"{"rs1"},width{"20","16"}},
"Operand"{"name"{"rd"},width{"15","11"}},
"OP-code"{"binary"{"00000111000"},width{"10","0"}}
},"mad"{type{"R_R_R"},"OP-code"{"binary"{"000001"},width{"31","26"}},
"Operand"{"name"{"rs0"},width{"25","21"}},
"Operand"{"name"{"rs1"},width{"20","16"}},
"Operand"{"name"{"rs2"},width{"15","11"}},
"Operand"{"name"{"rd"},width{"10","6"}},
"OP-code"{"binary"{"000001"},width{"5","0"}}
},"max"{type{"R_R"},"OP-code"{"binary"{"110000"},width{"31","26"}},
"Operand"{"name"{"rs0"},width{"25","21"}},
"Operand"{"name"{"rs1"},width{"20","16"}},
"Operand"{"name"{"rd"},width{"15","11"}},
"OP-code"{"binary"{"00000000000"},width{"10","0"}}
},"avg"{type{"R_R"},"OP-code"{"binary"{"110001"},width{"31","26"}},
"Operand"{"name"{"rs0"},width{"25","21"}},
"Operand"{"name"{"rs1"},width{"20","16"}},
"Operand"{"name"{"rd"},width{"15","11"}},
"OP-code"{"binary"{"00000000000"},width{"10","0"}}
},"avgu"{type{"R_R"},"OP-code"{"binary"{"110001"},width{"31","26"}},
"Operand"{"name"{"rs0"},width{"25","21"}},
"Operand"{"name"{"rs1"},width{"20","16"}},
"Operand"{"name"{"rd"},width{"15","11"}},
"OP-code"{"binary"{"00000000001"},width{"10","0"}}
},"fex"{type{"R_R_I"},"OP-code"{"binary"{"110011"},width{"31","26"}},
"Operand"{"name"{"rs"},width{"25","21"}},
"Operand"{"name"{"mask"},width{"20","16"}},
"Operand"{"name"{"rd"},width{"15","11"}},
"Operand"{"name"{"shift"},width{"10","6"}},
"OP-code"{"binary"{"000000"},width{"5","0"}}
},"swap"{type{"R_R_s"},"OP-code"{"binary"{"000001"},width{"31","26"}},
"Operand"{"name"{"rs0"},width{"25","21"}},
"Operand"{"name"{"rs1"},width{"20","16"}},
"OP-code"{"binary"{"1100000000000000"},width{"15","0"}}
},"minMax"{type{"R_R_Rb"},"OP-code"{"binary"{"110100"},width{"31","26"}},
"Operand"{"name"{"rs0"},width{"25","21"}},
"Operand"{"name"{"rs1"},width{"20","16"}},
"Operand"{"name"{"rdMin"},width{"15","11"}},
"Operand"{"name"{"rdMax"},width{"10","6"}},
"OP-code"{"binary"{"000000"},width{"5","0"}}
},"rot"{type{"R_I"},"OP-code"{"binary"{"110101"},width{"31","26"}},
"Operand"{"name"{"rs0"},width{"25","21"}},
"Operand"{"name"{"rd"},width{"20","16"}},
"Operand"{"name"{"const"},width{"15","0"}}
}}},
...
,"xchg"{Mode{"user_mode"},Behavior{"rs0 = rs1;
rs1 = rs0;"},Assert{""},Comment{""},Flags{""},Cycles{"1"}}
,"mac"{Mode{"user_mode"},Behavior{"rd = rd + ( rs0 * rs1 );"},Assert{""},Comment{""},Flags{""},Cycles{"1"}}
,"mad"{Mode{"user_mode"},Behavior{"rd = rs0 + ( rs1 * rs2 );"},Assert{""},Comment{""},Flags{""},Cycles{"1"}}
,"max"{Mode{"user_mode"},Behavior{"if ( rs0 > rs1) {
  rd = rs0;
}"},Assert{""},Comment{""},Flags{""},Cycles{"1"}}
,"avg"{Mode{"user_mode"},Behavior{"rd = (rs0+rs1)/2;"},Assert{""},Comment{""},Flags{""},Cycles{"1"}}
,"avgu"{Mode{"user_mode"},Behavior{"rd = (rs0+rs1)/2;"},Assert{""},Comment{""},Flags{""},Cycles{"1"}}
,"fex"{Mode{"user_mode"},Behavior{"rd = (rs & mask) >> shift;"},Assert{""},Comment{""},Flags{""},Cycles{"1"}}
,"swap"{Mode{"user_mode"},Behavior{"rs0 = (((rs1 << 16) & 4294901760) | ((rs1 >> 16) & 65535));"},Assert{""},Comment{""},Flags{""},Cycles{"1"}}
,"minMax"{Mode{"user_mode"},Behavior{"rdMin = rs0;"},Assert{""},Comment{""},Flags{""},Cycles{"1"}}
,"rot"{Mode{"user_mode"},Behavior{"rd = rs0;"},Assert{""},Comment{""},Flags{""},Cycles{"1"}}
}},
...
bit_width{"32"},
number_of_ports{"2"}}}
,"ROT0"{class{"rotator"},classpath{"/workdb/peas/"},use{"(unspecified)"},
parameter{
abstraction_level{for_simulation{"Behavior"},for_synthesis{"Gate"}},
bit_width{"32"}}}
},
...
,"bgeu"{variable{"wire[31:0]	target;
wire[31:0]	offset;
wire[3:0]	flag;
...
<target, c_out> = ADD0.adc( current_pc, offset, zero1 );
...
,"xchg"{variable{"wire [31:0] current_pc;
wire [31:0]  source0;
wire [31:0]  source1;"},clk(1){"wire [31:0]  inst;
...
clk(3){""},
clk(4){""},
clk(5){"null = GPR.write0( rs0, source1 );
null = GPR.write1( rs1, source0 );"}
}
,"mac"{variable{"wire[31:0]	result;
wire [31:0] current_pc;
wire [31:0]  source0;
wire [31:0]  source1;
...
clk(2){"source0 = GPR.read0(rs0);
source1 = GPR.read1(rs1);
source2 = GPR.read2(rd);"},
clk(3){"wire [63:0]  tmp_result64;
wire [31:0]  tmp_result32;
wire  c_out;
wire  c_in;

c_in = '0';

tmp_result64 = MUL0.mul( source0, source1 );
tmp_result32 = tmp_result64[31:0];

<result, c_out> = ADD0.adc( tmp_result32, source2, c_in );"},
clk(4){""},
clk(5){"null = GPR.write0(rd, result);"}
}
,"mad"{variable{"wire[31:0]	result;
wire [31:0] current_pc;
wire [31:0]  source0;
wire [31:0]  source1;
wire [31:0]  source2;"},clk(1){"wire [31:0]  inst;
...
result = MUX0.sel(source1, source0, cond);"},
clk(4){""},
clk(5){"null = GPR.write0(rd, result);"}
}
,"avg"{variable{"wire [31:0]   result;
wire [31:0] current_pc;
wire [31:0]  source0;
wire [31:0]  source1;"},clk(1){"wire [31:0]  inst;
...
clk(2){"source0 = GPR.read0(rs0);
source1 = GPR.read1(rs1);"},
clk(3){"wire [31:0] temp_result;
wire [4:0] value_1;
wire           cin;
wire           cout;

cin = '0';
<temp_result, cout> = ADD0.adc(source0, source1, cin);
value_1 = \"00001\";
result = SFT0.sra( temp_result, value_1 );"},
clk(4){""},
clk(5){"null = GPR.write0(rd, result);"}
}
,"avgu"{variable{"wire [31:0]   result;
wire [31:0] current_pc;
wire [31:0]  source0;
wire [31:0]  source1;"},clk(1){"wire [31:0]  inst;
...
<temp_result, cout> = ADD0.adc(source0, source1, cin);
value_1 = \"00001\";
result = SFT0.srl( temp_result, value_1 );"},
clk(4){""},
clk(5){"null = GPR.write0(rd, result);"}
}
,"fex"{variable{"wire [31:0]  result;
wire [31:0] current_pc;
wire [31:0]  source0;
wire [31:0]  source1;"},clk(1){"wire [31:0]  inst;
...
source1 = GPR.read1(mask);"},
clk(3){"wire [31:0] temp_result;
wire [3:0]   flags;

<temp_result, flags> = ALU0.and(source0, source1);
result = SFT0.sra(temp_result, shift);"},
clk(4){""},
clk(5){"null = GPR.write0(rd, result);"}
}
,"swap"{variable{"wire [31:0] source0;
wire [31:0] result;
wire [31:0] current_pc;"},clk(1){"wire [31:0]  inst;
...
null = PC.inc();"},
clk(2){"source0 = GPR.read0(rs0);"},
clk(3){"wire [15:0] upperHalf;
wire [15:0] lowerHalf;

upperHalf = source0[31:16];
lowerHalf = source0[15:0];
result = <lowerHalf, upperHalf>;"},
clk(4){""},
clk(5){"null = GPR.write0(rs1, result);"}
}
,"minMax"{variable{"wire [31:0]   resultMax;
wire [31:0]   resultMin;
wire [31:0] current_pc;
wire [31:0]  source0;
wire [31:0]  source1;"},clk(1){"wire [31:0]  inst;
...
resultMax = MUX0.sel(source1, source0, cond);
resultMin  = MUX1.sel(source0, source1, cond);"},
clk(4){""},
clk(5){"null = GPR.write0(rdMin, resultMin);
null = GPR.write1(rdMax, resultMax);"}
}
,"rot"{variable{"wire [31:0] source0;
wire [31:0] result;
wire [31:0] current_pc;"},clk(1){"wire [31:0]  inst;
...
null = PC.inc();"},
clk(2){"source0 = GPR.read0(rs0);"},
clk(3){"wire [7:0] amount;

amount = const[7:0];
result = ROT0.rot(source0, amount);"},
clk(4){""},
clk(5){"null = GPR.write0(rd, result);"}
}
}}
